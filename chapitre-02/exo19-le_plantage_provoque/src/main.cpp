...
// il remplit l'ecran d'une seule couleur, puis plante VOLONTAIREMENT (exercice 19).
...
// Exercice 19 : plantage VOLONTAIRE. On ecrit a l'adresse 0 (pointeur nul).
// "volatile" empeche le compilateur d'optimiser l'ecriture, meme en Release :
// le processeur fait vraiment l'acces memoire, et Android tue le programme.
